...
public interface Dictionary<K, V> extends Iterable<Entry<K, V>> {
    ...
    /**
     * Adds the value of this entry with the specified value.
     *
     * @param key
     * @param value
     */
    ...
    /**
     * Returns the value of the first entry containing the given key. Returns
    ...
    /**
     * Returns an iterator which allows to visit all the entries containing the
     * given key.
     *
     * @param key used in the search
